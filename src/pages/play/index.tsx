...
import { konversiTotalJariKeHuruf, totalJari, validasiJawabanPlayer } from "../../scripts";
import { ModalFunFact } from "../../components/ModalFunFact";

type StatusGame = "idle" | "menang" | "kalah";

export const HalamanBermain = () => {
    // States
    ...
    return (
        <div className="flex flex-col h-screen w-screen items-center justify-start p-5 gap-5">
            <div className="flex flex-col items-center justify-center gap-2 w-full">
                <p>Permainan ABCd Berapa Macam</p>
                <p>Jumlah Angka:</p>
                <Link to="/">
                    <button className="rounded-full bg-red-500 px-5 py-2.5 text-white hover:bg-red-600 cursor-pointer">Kembali</button>
                </Link>
            </div>
